...
{
    if (in_array($diamC, [1, 2, 3, 5]) && $diam > 50) {
        return "Cut";
    } else {
        return "Keep";
    }
...
for ($i = 0; $i < count($id); $i++) {
    $batch_updates[] = "UPDATE new_forest_50
        SET 
            Volume = {$volume[$i]}, 
...
echo "Total Data Processed: " . count($id) . "<br>";
include 'Victim50.php';
