...
// Hardcode the table names for regime55
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    // echo $x0 . $y0 . $blockX0 . $blockY0 . $cutAngle . $stemHeight; // Removed this line
    $buffer = 10;
    $count_query = "";
    ...
    if ($cutAngle >= 0 && $cutAngle < 90) {
        ...
        // echo "1" . $count_query; // Removed this line
        ...
        // echo "2" . $count_query2; // Removed this line
        ...
        // echo "3" . $count_query3; // Removed this line
        ...
        // echo "4" . $count_query4; // Removed this line
    }
...
mysqli_close($conn);
// Redirect to Growth55.php after Victim55.php is complete
header('Location: Growth55.php');
exit();
?>